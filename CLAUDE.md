...
## Some resources for marks-related forensic analysis - lower priority for now
...
**Key challenge:** Build a system robust to decreasing signal-to-noise ratios (80dB to <0dB). This is particularly important in datasets 5 and 6, which have the lowest SNRs. Dealing with the noise is absolutely critical. 
...
Think as an engineer. YOU must be the architect, the machine learning engineer, the God - i'm counting on you, and if you fail at this, I will have a very bad next few years.
